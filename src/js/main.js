...
function addBlock(height,sender,txn_count,tfc, recipitents,timestamp) {
   ...
   document.getElementById('blockList').innerHTML = document.getElementById('blockList').innerHTML + "\n <tr> <td>"+height+"</td> <td>"+sender+"</td> <td>"+txn_count+"</td> <td>"+ tfc+" AIO</td> <td>"+recipitents+"</td> <td>"+time+"</td> </tr> ";
}
