...
function addBlock(height,sender,txn_count,tfc, recipitents,timestamp) {
   ...
   document.getElementById('blockList').innerHTML = " <tr> <td>"+height+"</td> <td>"+sender+"</td> <td>"+txn_count+"</td> <td>"+ tfc+"AIO</td> <td>"+recipitents+"</td> <td>"+time+"</td> </tr>" + document.getElementById('blockList').innerHTML;;
}
